...
Mouse::Mouse() {
	memset(buttons		, 0, sizeof(bool)  * (int)MouseButtons::MAXSIZE);
	memset(holdButtons	, 0, sizeof(bool)  * (int)MouseButtons::MAXSIZE);
	memset(doubleClicks	, 0, sizeof(bool)  * (int)MouseButtons::MAXSIZE);
	memset(lastClickTime, 0, sizeof(float) * (int)MouseButtons::MAXSIZE);
...
void Mouse::UpdateFrameState(float msec) {
	memcpy(holdButtons, buttons, sizeof(bool)  * (int)MouseButtons::MAXSIZE);
	...
	for (int i = 0; i < (int)MouseButtons::MAXSIZE; ++i) {
